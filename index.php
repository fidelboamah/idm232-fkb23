    ...
    <div class="container">
        ...
        <div class="PIC">
            ...
            <div class="centered">
                ...
                <a href="search-menu.php" style="text-decoration: none; color: white;">
        ...
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="comp" id="b">
                    <img style="width: 50%;" src="img/soup.svg">
                </div>
                ...
                <div class="comp" id="d">
                    <img style="width: 50%;" src="img/open-box.svg">
                </div>
                ...
                <div class="comp" id="f">
                    <img style="width: 50%;" src="img/magician.svg">
                </div>
            </div>
        </div>
